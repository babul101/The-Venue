        ...
        <Slider {...settings}>
            <div>
               <div className='carousel_image'
                style={{background:`url(${one})`,height:`${window.innerHeight}px`}}>
               </div>
            </div>
            <div>
                <div className='carousel_image'
                style={{background:`url(${two})`,height:`${window.innerHeight}px`}}>
                </div>
            </div>
            <div>
                <div className='carousel_image'
                style={{background:`url(${three})`,height:`${window.innerHeight}px`}}>
                </div>
            </div>
            <div>
                <div className='carousel_image'
                style={{background:`url(${four})`,height:`${window.innerHeight}px`}}>
                </div>
            </div>
        </Slider>  
    </div>
